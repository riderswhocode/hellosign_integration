...
//Test Route
router.post('/template/create', urlEncodedParser, hsController.create_template)
router.post('/signature/send', urlEncodedParser, hsController.send_template)
router.get('/template/new', hsController.show_test_form)
//
